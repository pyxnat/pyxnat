...
# (module imports are okay, they're removed automatically).
#
...
def get_version():
    try:
        ...
        fp = op.join(op.split(op.dirname(__file__))[0], 'pyxnat', 'version.py')
...
project = 'pyxnat'
copyright = '2010-2023, Yannick Schwartz'
